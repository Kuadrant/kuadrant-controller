...
func (in *AuthSchemeSpec) DeepCopyInto(out *AuthSchemeSpec) {
	*out = *in
	if in.Patterns != nil {
		...
		*out = make(map[string]v1beta1.JSONPatternExpressions, len(*in))
		for key, val := range *in {
			var outVal []v1beta1.JSONPatternExpression
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(v1beta1.JSONPatternExpressions, len(*in))
				copy(*out, *in)
			}
			(*out)[key] = outVal
		}
	...
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1beta1.JSONPattern, len(*in))
		copy(*out, *in)
	}
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]*v1beta1.Identity, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1beta1.Identity)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = make([]*v1beta1.Metadata, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.Authorization != nil {
		...
		*out = make([]*v1beta1.Authorization, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1beta1.Authorization)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.Response != nil {
		...
		*out = make([]*v1beta1.Response, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1beta1.Response)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
func (in *MetadataPathSegmentKey) DeepCopy() *MetadataPathSegmentKey {
	...
	out := new(MetadataPathSegmentKey)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RateLimitPolicyStatus) DeepCopyInto(out *RateLimitPolicyStatus) {
	*out = *in
	...
	if in.GatewaysRateLimits != nil {
		in, out := &in.GatewaysRateLimits, &out.GatewaysRateLimits
		*out = make([]GatewayRateLimits, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
