...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthPolicyConfig) DeepCopyInto(out *AuthPolicyConfig) {
	*out = *in
	if in.Rules != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthPolicyConfig.
func (in *AuthPolicyConfig) DeepCopy() *AuthPolicyConfig {
	if in == nil {
		return nil
	}
	out := new(AuthPolicyConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AuthPolicySpec) DeepCopyInto(out *AuthPolicySpec) {
	*out = *in
	...
	if in.PolicyConfigs != nil {
		...
		*out = make([]*AuthPolicyConfig, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AuthPolicyConfig)
